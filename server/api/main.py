...
def show_enigma(request: Request, enigma_id: int, error: Optional[str] = None):
    ...
    if enigma['id'] == 4:
        if e4_question_idx == 0:
            ...
            e4_game_answers.append({'content' : "les pirates attaquent les marins pour voler leurs biens et leur argent ils cherchent egalement a prendre le controle des navires et de leur cargaison pour en tirer un profit personnel", 'role': 'ia'})
